...
class BaseOptions(object):
    ...
    def initialize(self):
        ...
        parser.add_argument('--dill_loss_coef', default=1, type=float)
        ...
        parser.add_argument("--iou_scores_loss_coef", default=1, type=float)
        ...
        # training stage
        parser.add_argument("--stage", type=str, default="pretrain", help="training stage: pretrain or distill")
        self.parser = parser
    ...
    def parse(self, a_feat_dir=None):
        ...
        if isinstance(self, TestOptions):
            ...
            save_fns = ['amr/model.py', 'amr/transformer.py']
